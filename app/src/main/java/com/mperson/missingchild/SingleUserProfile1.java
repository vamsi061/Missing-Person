...
public class SingleUserProfile1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_user_profile1);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder=new AlertDialog.Builder(SingleUserProfile1.this);
                ...
                builder.setNegativeButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                       /* DatabaseReference rem=FirebaseDatabase.getInstance().getReference("Missing_Info").child(UID);
                        rem.removeValue();
                        Toast.makeText(SingleUserProfile1.this,"Data Deleted Successfully:",Toast.LENGTH_SHORT).show();
                        Intent intent=new Intent(SingleUserProfile1.this,pcmainpage.class);
                        startActivity(intent);*/
                        Toast.makeText(SingleUserProfile1.this,"You don't have permissions to delete this data",Toast.LENGTH_SHORT).show();
