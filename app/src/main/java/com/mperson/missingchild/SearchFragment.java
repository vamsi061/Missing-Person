...
public class SearchFragment extends Fragment implements selectedListeners {
    RecyclerView recyclerView;
    DatabaseReference database;
    ProjectAdpater ProjectAdpater;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ProjectAdpater = new ProjectAdpater(getActivity(), itemlist, model -> onItemClicked(model));
        recyclerView.setAdapter(ProjectAdpater);
        ...
        database.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ProjectAdpater.notifyDataSetChanged();
            }
